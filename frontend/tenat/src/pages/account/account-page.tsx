...
import { errorMessage, roleFrom, roleLabelFor, useAuth } from '@/lib/auth'
import {
  validateAvatarFile,
...
export function AccountPage() {
  ...
  const roleLabel = roleLabelFor(roleFrom(session))
  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
      <PageHeader
        eyebrow="Account"
        title="Your profile"
        description="Name, email, password, and profile picture for this account."
      />
